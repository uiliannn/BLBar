...
public class ViewContasReceber extends javax.swing.JFrame {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jtfPesquisa2, javax.swing.GroupLayout.PREFERRED_SIZE, 398, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jbVisualizarPagar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbVisualizarPagar1ActionPerformed
        ...
        int linha = tbContasReceber.getSelectedRow();
        final int codigo = (int) tbContasReceber.getValueAt(linha, 0);
    ...
    private void jbVisualizarPagar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbVisualizarPagar2ActionPerformed
        ...
        final int codigo = (int) tbContasRecebidas.getValueAt(linha, 0);
        carregando.setVisible(true);
        Thread t = new Thread() {
            @Override
            public void run() {
    ...
    private void jbReceberContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbReceberContaActionPerformed
       modelContaReceber = new ModelContaReceber();
        try {
            ...
            modelContaReceber.setPagamento(bl.converterDataParaDateUS(new java.util.Date(System.currentTimeMillis())));
            //pegunta
    ...
    private boolean recuperarConta(int pCodigoConta) {
        ...
        this.jdData.setDate(modelContaReceber.getData());
        this.jdPagamento.setDate(modelContaReceber.getPagamento());
        this.jdVencimento.setDate(modelContaReceber.getVencimento());
        this.jtfValor.setText(String.valueOf(modelContaReceber.getValor()));
        this.jcbTipoPagamento.setSelectedItem(controllerTipoPagamento.getFormaPagamentoController(modelContaReceber.getTipoPagamento()).getDescricao());
        return true;
    }
    ...
    private boolean salvar() {
        ...
        try {
            modelContaReceber.setData(bl.converterDataParaDateUS(jdData.getDate()));
            modelContaReceber.setVencimento(bl.converterDataParaDateUS(jdVencimento.getDate()));
            modelContaReceber.setPagamento(bl.converterDataParaDateUS(jdPagamento.getDate()));
        } catch (Exception ex) {
   ...
   /**
    ...
    private boolean alterar() {
     ...
     private void carregarContasReceber() {
        listaModelConta = controllerContaReceber.getListaContaReceberController(0);
        ...
        for (int i = 0; i < cont; i++) {
            nomeCliente = controllerCliente.getClienteController(listaModelConta.get(i).getCodigoPessoa()).getNome();
     ...
     private void carregarContasRecebidas() {
        listaModelConta = controllerContaReceber.getListaContaReceberController(1);
    ...
    private void habilitaDesabilitarCampos(boolean operaco){
        ...
        this.cbClientes.setEnabled(operaco);
